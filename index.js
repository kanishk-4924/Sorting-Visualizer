...
function generateNewArray() {
  ...
  barsHeight[i] = 200
  bars[i].style.height = barsHeight[i] + 'px'
  document.getElementById("timecomp").innerHTML = "Time Complexity :";
  document.getElementById("spacecomp").innerHTML = "Space Complexity :";
}
...
function bubbleSort() {
  ...
  document.getElementById("timecomp").innerHTML = "Time Complexity : O(n^2)";
  document.getElementById("spacecomp").innerHTML = "Space Complexity : O(1)";
}
...
function mergeSort(start, end) {
  ...
  mergeSort(m + 1, end)
  merge(start, end)
  document.getElementById("timecomp").innerHTML = "Time Complexity : O(nlogn)";
  document.getElementById("spacecomp").innerHTML = "Space Complexity : O(n)";
}
